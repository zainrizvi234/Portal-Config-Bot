...
export declare const defaultBodyLimit: number;
export declare const isRawBodyError: (error: unknown) => error is rawBody.RawBodyError;
...
export declare const bufferIncomingMessage: (req: IncomingMessage, bodyLimit?: number | string) => Promise<BufferedIncomingMessage>;
