...
exports.defaultBodyLimit = 4 * 1024 * 1024; // 4 MB
const isRawBodyError = (error) => {
...
exports.isRawBodyError = isRawBodyError;
...
const parseAndVerifyHTTPRequest = async (options, req, _res) => {
    ...
    const bufferedReq = await (0, exports.bufferIncomingMessage)(req, options.bodyLimit);
...
const bufferIncomingMessage = async (req, bodyLimit) => {
    ...
    bufferedRequest.rawBody = await (0, raw_body_1.default)(req, rawBodyOptions);
