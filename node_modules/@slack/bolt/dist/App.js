...
class App {
    ...
    constructor({ signingSecret = undefined, endpoints = undefined, port = undefined, customRoutes = undefined, receiver = undefined, convoStore = undefined, token = undefined, appToken = undefined, botId = undefined, botUserId = undefined, authorize = undefined, logger = undefined, logLevel = undefined, ignoreSelf = true, clientOptions = undefined, processBeforeResponse = false, signatureVerification = true, clientId = undefined, clientSecret = undefined, stateSecret = undefined, redirectUri = undefined, installationStore = undefined, scopes = undefined, installerOptions = undefined, socketMode = undefined, developerMode = false, tokenVerificationEnabled = true, extendedErrorHandler = false, deferInitialization = false, attachFunctionToken = true, } = {}) {
        ...
        this.receiver = this.initReceiver(receiver, signingSecret, endpoints, port, customRoutes, processBeforeResponse, signatureVerification, clientId, clientSecret, stateSecret, redirectUri, installationStore, scopes, appToken, this.logger);
        /* ------------------------ Set authorize ----------------------------- */
    ...
    async processEvent(event) {
        ...
        if (type === helpers_1.IncomingEventType.Event && (0, helpers_1.isEventTypeToSkipAuthorize)(event)) {
            ...
            try {
                ...
                const authError = new errors_1.AuthorizationError(`Authorization of incoming event did not succeed. ${e.message}`, e);
        ...
        if (body.response_url) {
            listenerArgs.respond = (0, context_1.createRespond)(this.fetchFn, body.response_url);
        }
            ...
            listenerArgs.respond = (0, context_1.createRespond)(this.fetchFn, body.response_urls[0].response_url);
        }
        // Set ack() utility
        if (type !== helpers_1.IncomingEventType.Event) {
...
function defaultErrorHandler(logger) {
    return (error) => {
        ...
        else if (error instanceof web_api_1.WebAPIRateLimitedError) {
